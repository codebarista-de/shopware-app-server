...
import de.codebarista.shopware.appbackend.sdk.exception.ShopwareAccessException;
import de.codebarista.shopware.appbackend.sdk.model.ShopwareShopEntity;
import de.codebarista.shopware.appbackend.sdk.service.dto.auth.ShopwareAdminApiAccessTokenDto;
import de.codebarista.shopware.appbackend.sdk.service.dto.auth.ShopwareAdminApiTokenRequest;
...
public class ShopwareAccessTokenClientService {
    ...
    public ShopwareAccessTokenClientService(RestTemplate restTemplate,
                                            ...
                                            AppBackendSdkProperties sdkProperties) {
