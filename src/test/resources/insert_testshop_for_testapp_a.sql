INSERT INTO SHOPWARE_SHOP(ID, APP_KEY, SHOP_ID, SHOP_HOST, SHOP_REQUEST_URL, SHOP_SECRET, REGISTRATION_REQUESTED_AT,
            ...
            LAST_USED_AT, DELETED_AT, PENDING_SHOP_SECRET, PENDING_SHOP_URL, REREGISTRATION_REQUIRES_SHOP_SIGNATURE)
    VALUES(1234, "test-a", "test1234", "myshopurl.test", "http://myshopurl.test",
            ...
            "6.X.X.X", "2021-12-01 02:00:00.000", null, null, null, null, false);
